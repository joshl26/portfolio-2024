    ...
    <section className="my-8 px-3">
      ...
      >
        <section className="portfolio-main-section">
          ...
          <div className="flex flex-row justify-between gap-x-3">
            <h4>December 2023 - February 2024</h4>
          ...
          <p className="portfolio-p mb-8">
            This website is designed to be user-friendly and visually appealing,
      ...
      >
        <section className="portfolio-main-section">
          ...
          <p className="portfolio-p">
            One major challenge while building this project was integrating the
            GraphQL API with React for seamless data communication between the
            front-end and back-end. However, with thorough documentation
          ...
          <p className="portfolio-p">
            ...
            improved performance and SEO optimization. With MedusaJS's built-in
            server-side rendering capabilities powered by Next.js, this could be
            achieved seamlessly without much effort.
          </p>
          <p className="portfolio-p">
            ...
            e-commerce solution. It offers all the necessary features to create
            a fully functional online store while providing developers with
            enough room for customization and personalization according to
            business needs. This project serves as an example of how businesses
            can leverage modern technologies such as MedusaJS to provide unique
            and personalized shopping experiences for their customers.
          </p>
        </section>
      </motion.div>
      <motion.div
