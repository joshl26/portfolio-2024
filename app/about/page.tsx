            ...
            <div className="experience-card">
              ...
              <ul className="portfolio-about-list">
                <li>
                  ...
                  type. The layers, line divors, type, and weights were adjusted
                  while conforming to the companys standards which were precise
            ...
            <div className="experience-card">
              ...
              <ul className="portfolio-about-list">
                ...
                <li>
                  ...
                  MQTT data transmission protodiv (PUB/SUB).
                </li>
                <li>
